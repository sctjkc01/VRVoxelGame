namespace VRTK
{
    ...
    {
        /// <summary>
        /// Which controller is interacting
        /// </summary>
        public uint controllerIndex;
        /// <summary>
        /// How hard is thetrigger being pulled
        /// </summary>
        public float buttonPressure;
        /// <summary>
        /// Location of touchpad touch
        /// </summary>
        public Vector2 touchpadAxis;
        /// <summary>
        /// Angle of touchpad touch
        /// </summary>
        public float touchpadAngle;
        /// <summary>
        /// Transform of interacting controller
        /// </summary>
    ...
    public class VRTK_ControllerEvents : MonoBehaviour
    {
        ...
        public void VRTKSendMessage(string msg, ControllerInteractionEventArgs e) {
            var grab = GetComponent<VRTK_InteractGrab>();
            if(grab && grab.GetGrabbedObject() != null) {
                grab.GetGrabbedObject().SendMessage(msg, e, SendMessageOptions.DontRequireReceiver);
            } else {
                var touch = GetComponent<VRTK_InteractTouch>();
                if(touch && touch.GetTouchedObject() != null && !touch.GetTouchedObject().GetComponent<VRTK_InteractableObject>().requireGrabbedToInteract) {
                    touch.GetTouchedObject().SendMessage(msg, e, SendMessageOptions.DontRequireReceiver);
                }
            }
        }
        ...
        public virtual void OnTriggerAxisChanged(ControllerInteractionEventArgs e)
        {
            ...
            VRTKSendMessage("TriggerChange", e);
        }
        ...
        public virtual void OnTouchpadPressed(ControllerInteractionEventArgs e)
        {
            ...
            VRTKSendMessage("TouchpadDown", e);
        }
        ...
        public virtual void OnTouchpadTouchStart(ControllerInteractionEventArgs e)
        {
            ...
            VRTKSendMessage("TouchpadTouch", e);
        }
        ...
        public virtual void OnTouchpadTouchEnd(ControllerInteractionEventArgs e)
        {
            ...
            VRTKSendMessage("TouchpadUntouch", e);
        }
        ...
        public virtual void OnTouchpadAxisChanged(ControllerInteractionEventArgs e)
        {
            ...
            VRTKSendMessage("TouchpadScroll", e);
        }
